...
## Rules and scores
There are currently 6 sets of rules, each one is able to increment the spam
score by or to 1.
...
### Text and HTML parts
If the the biggest text part is smaller than 25 characters, the score is
...
### Link count
If an HTML part or the biggest text part contains 5 or more links to a same
